...
export default function Hero({ content }) {
    const { mainContent, mainContentImage } = content
    return (
        <section className="w-full" >
            <div className={styles['divider-top'] + " invisible md:visible"}>
            ...
            <div className="hero min-h-min -mt-44">
                <div className="hero-content flex-col justify-center lg:flex-row-reverse">
                    <div style={{
                        ...
                        width={mainContentImage.fields.file.details.image.width}
                        height={mainContentImage.fields.file.details.image.height}
                        className="p-10" />
                    </div>
                    <div>
                        <p>{mainContent.content[0].content[0].value || 'Contenido'}</p>
